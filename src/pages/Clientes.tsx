...
import { ListView } from './clientes/ListView'
import { FormView } from './clientes/FormView'
import { DetailView } from './clientes/DetailView'
import { BackLink } from '../components/BackLink'

type View = 'list' | 'form' | 'detail'

const headings: Record<View, { crumbs: string[]; title: string; sub: string }> = {
  list: { crumbs: ['Clientes'], title: 'Clientes', sub: 'cadastro e gestão' },
  form: {
    crumbs: ['Clientes', 'Novo Cliente'],
    title: 'Novo Cliente',
    sub: 'preencha os dados',
  },
  detail: {
    crumbs: ['Clientes', 'Marina Andrade Costa'],
    title: 'Marina Andrade Costa',
    sub: 'ficha completa',
  },
}
      ...
      <div className="topbar">
        ...
        <div className="topbar-actions">
          <input
            ...
            placeholder="Buscar cliente, CPF, e-mail, telefone…"
          />
